        ...
        handler: function (request, reply) 
        {
            ...
            if(comprobacion == "correo.unimet.edu.ve")
            {
                ...
                }).then(function(estudiante)
                {
                    ...
                    {
                        request.cookieAuth.set(estudiante); //Asigno la cookie de inicio de sesión al estudiante
                        request.auth.scope = 'Estudiante';
                        return reply.redirect('/perfilEstudiante/?id='+encodeURIComponent(estudiante.IDEstudiante));
                    }
                });
            }
